 ...
 return (
   ...
   <div className="flex-column m-4 p-5">
    ...
    <div class="doc">
        ...
        <h5 className="ml-3 justify-content-start d-lg-block d-none">2)Como faço para obter o Documento Provisório de Registro Nacional Migratório (DPRNM), previsto no Decreto nº 9.277/2018?</h5>
       ...
       ou no momento em que for renovar o Protocolo de Refúgio.
            ...
            Ou seja: o solicitante não precisa adotar nenhuma medida adicional: caso queira pedir refúgio pela primeira vez, deverá cadastrar-se no Sisconare </span> <br/> <span className="ml-3 justify-content-start d-lg-block d-none">
                ...
                <h5 className="ml-3 justify-content-start d-none d-lg-none">3)Qual a diferença entre o Protocolo de Refúgio e o Documento Provisório de Registro Nacional Migratório (DPRNM)?</h5>
               <span className="ml-3 justify-content-start d-lg-block d-none"> O Protocolo de Refúgio é o documento que o solicitante recebe imediatamente ao pedir o reconhecimento da condição de refugiado </span> <br/>
                 <span className="ml-3 justify-content-start d-lg-block d-none">
            ...
            <br/>
                 <span className="ml-3 justify-content-start d-lg-block d-none">O DPRNM, previsto no Decreto nº 9.277/2018, passou a ser o documento de identificação de solicitantes de refúgio, em substituição do Protocolo de Refúgio.</span>

                  <br/>
                 <span className="ml-3 justify-content-start d-lg-block d-none"> LEMBRE-SE: o DPRNM possui validade de um ano, e deve ser renovado anualmente na Polícia Federal.</span>
        </div>
        <div className='doc'>
            ...
            <span>
                ...
                <h5 class="ml-3 justify-content-start d-none d-lg-block">2) Posso escolher o local de realização da entrevista?</h5>
                <span>
           ...
           <h5 class="ml-3 justify-content-start d-none d-lg-block">3) Caso minha entrevista esteja demorando muito, como posso solicitar mais urgência?</h5>
                <span>
                ...
                </span> <br/> <span className="ml-3 justify-content-start d-lg-block d-none"> Lembre-se de que, enquanto o seu pedido de refúgio está em análise, a sua situação migratória no Brasil está regular </span> <br/> 
                <span className="ml-3 justify-content-start d-lg-block d-none"> 
